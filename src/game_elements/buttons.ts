...
namespace GameElements {
    ...
    export namespace Buttons {
        ...
        export class RunningButton implements IButton {
            ...
            render(): HTMLElement {
                return new ElementCreator("button").setId("running_btn").onHover(() => this.onHover())
        ...
        export class ImStupidButton implements IButton {
            ...
            render(): HTMLElement {
                return new ElementCreator("button").setText(this.text).onClick(() => this.onClick()).toElement();
            }
            onClick(): void {
